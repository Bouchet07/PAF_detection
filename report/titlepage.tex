...
{\itshape Prediction of Paroxysmal Atrial Fibrillation from the Sinus Rhythm Electrocardiogram Using Deep Neural Networks}\\[1.76cm] % Título en inglés

% Autor
\fontsize{12.04}{14.5}\selectfont
Autor\\[0.63cm]
\fontsize{18.07}{22}\selectfont
Diego Bouchet Agudo\\[1.66cm]

% Director/es
\fontsize{12.04}{14.5}\selectfont
Directores\\[0.58cm]
\fontsize{13.97}{17}\selectfont
Juan Pablo artínez Cortés y Antonio Miguel Artiaga\\[0.78cm]
