...
{\itshape Prediction of Paroxysmal Atrial Fibrillation from the Sinus Rhythm Electrocardiogram Using Deep Neural Networks}\\[1cm] % Título en inglés

% Autor
\fontsize{12.04}{14.5}\selectfont
Autor\\[0.4cm]
\fontsize{18.07}{22}\selectfont
Diego Bouchet Agudo\\[0.75cm]
...
Titulación\\[0.49cm]
\fontsize{13.97}{17}\selectfont
Grado en Ingeniería de Tecnologías y Servicios de Telecomunicación\\[0.3cm] % Cambiar por tu grado o máster
