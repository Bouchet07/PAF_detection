...
\begin{itemize}
  ...
  Esta clase corresponde al estado inmediatamente anterior al inicio de un episodio de
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{img/resnet.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{img/seresnet.pdf}
  \caption{Arquitectura SEResNet 1D. Tras cada bloque residual se incorpora un módulo
  Squeeze-and-Excitation
  que recalibra adaptativamente los pesos de los canales de extracción de características.}
  \label{fig:seresnet}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{img/transformer.pdf}
  \caption{Arquitectura híbrida CNN-Transformer. Se utiliza un \textit{frontend}
  convolucional para la extracción local y reducción de dimensionalidad, seguido de
  codificadores posicionales y un \textit{Transformer Encoder}
  para la atención global.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{img/mamba.pdf}
  \caption{Arquitectura híbrida CNN-Mamba. La secuencia latente generada por el
  \textit{frontend} convolucional es procesada de forma puramente secuencial mediante
  bloques SSM selectivos, prescindiendo de codificadores
  posicionales.}
  \label{fig:mamba}
\end{figure}
