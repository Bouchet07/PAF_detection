...
La Fibrilación Auricular (FA) es la arritmia cardíaca más común, caracterizada por una activación
eléctrica auricular caótica (como se ilustra en la Figura~\ref{fig:ejemplo}).
...
estrategia no es capaz de analizar las distorsiones morfológicas locales de las señales
...
procedente de distintas bases de datos, evaluando los modelos mediante una validación cruzada inter-sujeto estricta.
